        ...
        <nav className="hidden items-center gap-8 md:flex">
          ...
          <button
            ...
            className={cn(
              ...
              "rounded-full bg-coral-900 text-white hover:bg-coral-800 font-semibold px-5"
            )}
          >
            {t("cta")}
          </button>
            ...
            <SheetContent side="right" className="w-72 bg-white border-stone-200">
              ...
              <nav className="mt-8 flex flex-col gap-4">
                ...
                <div className="pt-4">
                  <button
                    onClick={openContactModal}
                    className={cn(buttonVariants({ size: "default" }), "w-full rounded-full bg-coral-900 text-white hover:bg-coral-800 font-semibold justify-center")}
                  >
                    {t("cta")}
                  </button>
                </div>
